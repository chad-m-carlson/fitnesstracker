  ...
  return (
    <PageContainer>
      <CardContainer>
        <h1>Admin Tools</h1>
        <Segment
          onClick={() => props.history.push(`/newworkout`)}
        ...
        >
          <h3>
            {showExerciseIndex ? "Hide All Exercises" : "Show All Exercises"}
          </h3>
        </Segment>
        {showExerciseIndex && (
          <Segment>
        ...
        <Segment style={{ cursor: "pointer", width: "75%" }}>
          <h3 onClick={() => setShowExerciseForm(!showExerciseForm)}>
            Add an exercise
          </h3>
        </Segment>
        {showExerciseForm && (
        ...
        <Segment style={{ cursor: "pointer", width: "75%" }}>
          <h3 onClick={() => setShowRepsForm(!showRepsForm)}>Add Reps/Tempo</h3>
        </Segment>
        {showRepsForm && (
          <Segment style={{ width: "80%" }}>
            <RepsForm />
